export default [
  {
    ...
    description: {
      ...
      ro: 'Diverse ingrediente au fost arse, împletite iar mai apoi îmbinate împreună pentru a forma o amuletă cu protecție scăzută. Astfel de amulete simple au reprezintat o tehnică comună de supraviețuire încă din antichitate.',
...

  {
    ...
    description: {
      ...
      ro: 'Oamenii antici ai deșertului au adunat pietre speciale iar apoi le-au încrustat în scarabei cu ajutorul unei magii negre, puternice. Mulți oameni importanți ai acele civilizații antice purtau aceste amulete pentru protecție și pentru a-și arăta statura.',
...

  {
    ...
    description: {
      ...
      ro: 'Teocrațiile de după război au creat simboluri Omega divine, ca un mijloc de protecție. Aceste simboluri au fost folosite pentru a împiedica atacurile, fiind considerate daruri de protecție și prezentate potențialilor adepți religioși.',
...

  {
    ...
    description: {
      ...
      ro: 'Cabluri de metal se împletesc între ele, producând arcuri electrice și dându-i acestei amuletei un aspect viu. Savanții speculează că acestea provin dintr-un tărâm pierdut, dar nimeni nu pare să fie sigur de acest lucru.',
